...
//       #VALORDEUDA#
        ...
        rpt.print("Que "+data["#NOMBRE#"]+", identificado(a) con "+data["#TIPODOCUMENTO#"]+" número "+data["#CEDULA#"]+" como deudor, adeuda a la COOPERATIVA PIO XII DE COCORNA la suma de "+data["#VALORLETRAS#"] + " pesos ($"+data["#VALORDEUDA#"]+"),saldo a la fecha por concepto de créditos.",{
            align: "left"
           });
        ...
        var rpt = new Report(path.join(__dirname, "../../../temp/myreportCredito.pdf"));
